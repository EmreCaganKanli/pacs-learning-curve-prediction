...
- Some included CSV manifests contain paths to locally generated checkpoints and training artifacts using Windows-style path separators from the original experiment run. These artifacts are intentionally excluded from version control and are regenerated by Stages 1–2.
